...
def ds_to_merlinformat(src_dir: str, out_dir: str, use_json: bool = True, speaker_name: str = None):
    """
    ...
    if use_json:
        with open(os.path.join(src_dir, "info.json")) as json_f:
            ...
            for record_id, item in info.items():
                ...
                copy_to_merlin(src_dir, wav_dir, txt_dir, wav_fname, txt_fname, speaker_name)
    else:
